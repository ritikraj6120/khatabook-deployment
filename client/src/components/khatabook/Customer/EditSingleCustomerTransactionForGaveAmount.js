...
const EditSingleCustomerTransactionForGaveAmount = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		dispatch(updateCustomerTransaction(history, transactionid, singlecustomerid, parseInt(newTransaction), 0, newTransactionBilldetails, addBillNo, newTransactiondate));
	}
